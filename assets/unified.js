...
const initial=location.hash.replace('#','');if(['home','dose','petct-dose','antibiotics','service-medicines','diseases','prescription-check','interactions','hepatotoxicity','pregnancy-lactation','icd10-bhyt','pediatric-dose','injectable-guide','sources'].includes(initial))showView(initial);
